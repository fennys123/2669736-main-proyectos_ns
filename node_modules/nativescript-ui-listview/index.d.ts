import { ViewBase, Property, View, KeyedTemplate, EventData, Color, StackLayout } from '@nativescript/core';
 ...
 */
export class ListViewEventData implements EventData {
	/**
 ...
 */
export class ListViewScrollEventData implements EventData {
	/**
 ...
 */
export class ReorderHandle extends StackLayout {
	constructor();
}
